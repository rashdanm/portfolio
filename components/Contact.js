...
const Contact = () => {
  return (
    <div
      id="contact"
      className="flex flex-col w-full px-5 py-5 bg-white lg:flex-row lg:h-screen lg:justify-start"
    >
      <div className="flex flex-col justify-center px-5 lg:w-2/4 lg:pt-6">
        ...
        <div className="flex pt-5 pb-5">
          <div className="pr-3 hover:text-red-700">
            <svg
              className="text-black fill-current hover:text-green-700"
      ...
      <div className="flex items-start w-full h-screen px-3 lg:w-2/4 lg:items-center">
        <Form />
      </div>
    </div>
  );
